...
export function todoForm(){
    ...
    formContainer.innerHTML=`
        <form>
            <div>
                <label for="name" >Title:</label><span id='title-error'>Titles cannot be empty or longer than 15 character.</span>
                <input 
                type="text"
                name="name"
            ...
            <div>
                <label for="due-date" id="date-label" >Due date: </label>
...
function editForm(todo){
    ...
    switch(todo.querySelector('.todo-priority').style.backgroundColor){
        ...
        case 'springgreen':
            ...
            break;
        default:
            console.log('error with edit form priority');
        ...
        <form>
            ...
            <div>
               ...
               >
                ...
                <div class="form-button add">Edit</div>
                <div class="form-button cancel">Cancel</div>
...
function projectEdit(project){
    ...
    if(!storage.has(input.value)){
        ...
        newStorage(input.value);
            ...
            alert('Projects names cannot be empty or longer than 15 character')
        }
    }
    else{
